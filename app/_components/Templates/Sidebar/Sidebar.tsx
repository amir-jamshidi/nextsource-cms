...
const Sidebar = () => {
    return (
        <aside className='bg-white dark:bg-primary-900 px-6 shadow z-[2] overflow-y-auto' style={{ gridColumn: '1 / 3', gridRow: '1 / 3' }}>
            <div className='flex flex-col justify-around h-full'>
                <div className='flex items-center justify-center gap-x-0.5'>
                    <p className='font-mo-bold text-2xl text-primary-800 dark: dark:text-primary-0'>نکستـــ</p>
                    <p className='font-mo-bold text-xl text-primary-800 dark:text-blue-500'>ســـورس</p>
                </div>
                <SidebarMenus />
