...
const VerifyForm = ({ phone }: { phone: string }) => {
    ...
    return (
        <form className='mt-4 mb-4' onSubmit={handleVerify}>
            <div className='flex bg-gray-50 border dark:border-primary-700/50 border-primary-50 dark:bg-primary-900 items-center rounded-xl px-2.5 h-11'>
            ...
            <input disabled={isLoading} type='submit' className='h-11 bg-blue-400 dark:bg-blue-600 w-full text-sm rounded-xl tracking-tight text-white mt-2 dark:disabled:bg-blue-500 disabled:bg-blue-300 transition-colors cursor-pointer disabled:cursor-not-allowed' value={isLoading ? 'لطفا صبر کنید' : 'ورود به پنل'} />
        </form>
    )
}
