import { IUserDetails } from '@/app/_types'
import { HiNoSymbol, HiOutlineAcademicCap, HiOutlineUser, HiOutlineUserGroup } from 'react-icons/hi2'
import DetailsBox from '../../Modules/DetailsBox'
import DetailsBoxesContainer from '../../Modules/DetailsBoxesContainer'

const UserDetailsBoxes = ({ usersDetails }: IUserDetails) => {
    return (
