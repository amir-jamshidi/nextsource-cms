...
const TicketButtonDelete = ({ ticketID }: TicketButtonDeleteProps) => {
    return (
        <Modal>
            <Modal.Open>
                <span className='p-1 bg-rose-200 rounded-full cursor-pointer'>
            ...
            <Modal.Window>
                <div className='w-1/3 bg-white rounded-xl shadow overflow-hidden'>
                    <div className="flex gap-x-2 items-center p-3">
                        ...
                        <p className='text-primary-800 text-sm font-ir-medium tracking-tight'>از حدف کردن تیکت مطمئن هستید ؟</p>
                    </div>
