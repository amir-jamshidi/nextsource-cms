...
const TicketFilter = () => {
    return (
        <FilterContainer title='تیکت هــا'>
            <Filter resetOption={{ key: 'page', value: 1 }} defaultValue={'all'} option={{ key: 'status', options: [{ title: 'همه', value: 'all' }, { title: 'با پاسخ', value: 'answer' }, { title: 'بدون پاسخ', value: 'noanswer' }] }} />
