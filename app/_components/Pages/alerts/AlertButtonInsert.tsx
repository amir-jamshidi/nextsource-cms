                    ...
                    <form action="" onSubmit={handleSubmit(handleAddAlert)}>
                        <div className="p-4">
                            <div className="grid grid-cols-2 gap-2.5">
                                <input {...register('title')} type="text" placeholder="عنوان پیام" className="bg-primary-0 dark:bg-primary-800 dark:border-primary-700 dark:text-primary-100 h-11 rounded-xl border text-sm border-gray-100 outline-none text-primary-800 px-2.5" />
                                <input {...register('href')} type="text" placeholder="لینک پیام (اختیاری)" className="bg-primary-0 dark:bg-primary-800 dark:border-primary-700 dark:text-primary-100 h-11 rounded-xl border text-sm border-gray-100 outline-none text-primary-800 px-2.5" />
                                <input {...register('body')} type="text" placeholder="متن پیام" className="col-span-2 bg-primary-0 dark:bg-primary-800 dark:border-primary-700 dark:text-primary-100 h-11 rounded-xl border text-sm border-gray-100 outline-none text-primary-800 px-2.5" />
                            </div>
                            <div className="mt-4 flex gap-x-2.5 items-center">
                                <p className="text-sm font-ir-medium text-primary-800 tracking-tight dark:text-primary-100">نوع پیام : </p>
                                <label className=" cursor-pointer font-mo gap-x-0.5 flex items-center text-green-500 border-l border-l-primary-50 dark:border-l-primary-800 pl-2.5">
                                    <input type="radio"{...register('type')} value='success' />
                                    موفق
                                </label>
                                <label className=" cursor-pointer font-mo text-amber-500 gap-x-0.5 flex items-center border-l border-l-primary-50 dark:border-l-primary-800 pl-2.5">
