...
const SingleProductBoxes = ({ productDetails }) => {
    ...
    return (
        <DetailsBoxesContainer>
            ...
            <DetailsBox color='bg-green-200 dark:bg-green-800' title='قیمت محصول' value={`${productDetails.price.toLocaleString()} تومان`} icon={<HiOutlineCircleStack size={45} className='text-green-600 dark:text-green-300' />} />
