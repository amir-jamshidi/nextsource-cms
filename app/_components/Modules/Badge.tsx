...
const Badge = ({ text, type, icon = true }: { text: string, type: "green" | "blue" | "red" | "rose" | "violet", icon?: boolean }) => {
    ...
    return (
        <div className={`${extraClasses} text-xs rounded-xl pr-2 pl-3 py-1 flex items-center gap-x-1`}>
            {icon && (
